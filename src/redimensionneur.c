...
int main(int argc, char* argv[]){
    ...
    zone_ecrivain.tailleDonnees = width * height * headerInfos.canaux;
    ...
    zone_ecrivain.tailleDonnees = height * width * headerInfos.canaux;
    ...
    {
    case 0:
        resized_grid = resizeNearestNeighborInit(height, width, headerInfos.hauteur, headerInfos.largeur);
        break;
    case 1:
        resized_grid = resizeBilinearInit(height, width, headerInfos.hauteur, headerInfos.largeur);
        break;
    default:
        break;
    }
